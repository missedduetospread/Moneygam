...
void CRender::LoadFonts()
{
	...
	FontSmall = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\comfortaa.ttf)", H::Draw.Scale(11), &fontConfig, fontRange);
	FontRegular = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\comfortaa.ttf)", H::Draw.Scale(13), &fontConfig, fontRange);
	FontBold = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\comfortaab.ttf)", H::Draw.Scale(13), &fontConfig, fontRange);
	FontLarge = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\comfortaa.ttf)", H::Draw.Scale(14), &fontConfig, fontRange);
